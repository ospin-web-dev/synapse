...
describe('create Process Functionality Image', () => {
  ...
  it('calls amplifys API.post with the expected args', async () => {
    await synapse.deviceAPI.process.functionality.image.createFromFile(
  ...
  it('should show an error message when the file could not be found', async () => {
    await expect(synapse.deviceAPI.process.functionality.image.createFromFile(
  ...
  describe('on failure', () => {
    ...
    it('should throw an error', async () => {
      ...
      await expect(synapse.deviceAPI.process.functionality.image.createFromFile(processId, functionalityId, body))
